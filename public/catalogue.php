                ...
                <div class="products-grid">
                    ...
                    <article class="product-card">
                        ...
                        <div class="product-card__content">
                            ...
                            <a href="produit.html?id=1" class="product-card__title"><?= $products[0]["name"] ?></a>
                            <div class="product-card__price"><span class="product-card__price-current"><?= $products[0]["price"] ?> €</span></div>
                            <p class="product-card__stock product-card__stock--available"><?= isAvailable($products[0]["stock"]).'('.$products[0]["stock"].')' ?></p>
                    ...
                    <article class="product-card">
                        ...
                        <div class="product-card__content">
                            ...
                            <a href="produit.html?id=2" class="product-card__title"><?= $products[1]["name"] ?></a>
                            <div class="product-card__price">
                                <span class="product-card__price-current"><?= sprintf("%01.2f",calculedPriceDiscount($products[1]["price"],20)) ?> €</span>
                                <span class="product-card__price-old"><?= $products[1]["price"] ?> €</span>
                            </div>
                    ...
                    <article class="product-card">
                        ...
                        <div class="product-card__content">
                            ...
                            <a href="produit.html?id=3" class="product-card__title"><?= $products[2]["name"] ?></a>
                            <div class="product-card__price"><span class="product-card__price-current"><?= $products[2]["price"] ?> €</span></div>
                            <p class="product-card__stock product-card__stock--available"><?= isAvailable($products[2]["stock"]).'('.$products[2]["stock"].')' ?></p>
                            <div class="product-card__actions">
                                <form action="panier.html" method="POST">
                    ...
                    <article class="product-card">
                        ...
                        <div class="product-card__content">
                            <span class="product-card__category">Vêtements</span>
                            <a href="produit.html?id=4" class="product-card__title"><?= $products[3]["name"] ?></a>
                            <div class="product-card__price">
                                <span class="product-card__price-current"><?= sprintf("%01.2f",calculedPriceDiscount($products[3]["price"],30)) ?> €</span>
                                <span class="product-card__price-old"><?= $products[3]["price"] ?> €</span>
                            </div>
                            <p class="product-card__stock product-card__stock--available"><?= isAvailable($products[3]["stock"]).'('.$products[3]["stock"].')' ?></p>
                            <div class="product-card__actions">
                                <form action="panier.html" method="POST">
                    ...
                    <article class="product-card">
                        ...
                        <div class="product-card__content">
                            <span class="product-card__category">Accessoires</span>
                            <a href="produit.html?id=5" class="product-card__title"><?= $products[4]["name"] ?></a>
                            <div class="product-card__price"><span class="product-card__price-current"><?= $products[4]["price"] ?> €</span></div>
                            <p class="product-card__stock product-card__stock--available"><?= isAvailable($products[4]["stock"]).'('.$products[4]["stock"].')' ?></p>
                            <div class="product-card__actions">
                                <form action="panier.html" method="POST">
                    ...
                    <article class="product-card">
                        ...
                        <div class="product-card__content">
                            <span class="product-card__category">Accessoires</span>
                            <a href="produit.html?id=6" class="product-card__title"><?= $products[5]["name"] ?></a>
                            <div class="product-card__price"><span class="product-card__price-current"><?= $products[5]["price"] ?> €</span></div>
                            <p class="product-card__stock product-card__stock--out"><?= isAvailable($products[5]["stock"]).'('.$products[5]["stock"].')' ?></p>
                            <div class="product-card__actions">
